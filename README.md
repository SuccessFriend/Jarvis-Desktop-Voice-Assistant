...
- Install all the requirements given in **[Requirements.txt](https://github.com/Caesar0dev/Jarvis-Desktop-Voice-Assistant/blob/main/Requirements.txt)**
...
- Github: [@Caesar0dev](https://github.com/Caesar0dev)
